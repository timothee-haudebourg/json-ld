...
// use crate::{
// 	algorithms::{
// 		context_processing::define::TermDefinitionEnv, error::Error, expansion::ExpansionEnv,
// 		warning::Warning,
// 	},
// 	syntax::{
...
// 	},
// 	Id, Loader, Nullable, ProcessedContext, Term,
// };
...
// 	pub async fn expand_iri(
// 		&mut self,
// 		// mut env: TermDefinitionEnv<'_, impl Loader>,
// 		mut env: ExpansionEnv<'_, impl Loader>,
...
// 				// Processing.
// 				Box::pin(self.define(env.for_recursive_definition(), value.into(), false)).await?;
...
// 							return Ok(Term::Id(Id::from_string(result)));
// 						}
// 						Some(_) => return Ok(invalid_iri(value.to_owned(), env.on_warning)),
// 						None => (),
// 					}
// 				}
...
// 				// Return value as is.
// 				Ok(invalid_iri(value.to_owned(), env.on_warning))
// 			}
// 		}
// 	}
